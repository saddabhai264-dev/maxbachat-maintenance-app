...
After changing environment variables, create a fresh deployment from the latest commit. If Vercel logs show an older commit hash, redeploy from the newest GitHub commit.
